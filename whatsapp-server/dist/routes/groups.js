...
router.post("/:jid/presence", (0, express_validator_1.body)("presence").isString().isIn(Object.values(Types_1.WAPresence)), request_validator_1.default, session_validator_1.default, controllers_1.group.presence);
router.get("/:jid/photo", session_validator_1.default, controllers_1.group.photo);
router.post("/create", (0, express_validator_1.body)("subject").isString().notEmpty(), (0, express_validator_1.body)("participants").isArray({ min: 1, max: 1024 }).notEmpty(), request_validator_1.default, session_validator_1.default, controllers_1.group.create);
...
router.put("/:jid/update/setting", (0, express_validator_1.body)("action")
    .isString()
    .isIn(["announcement", "not_announcement", "unlocked", "locked"])
    .notEmpty(), request_validator_1.default, session_validator_1.default, controllers_1.group.updateSetting);
